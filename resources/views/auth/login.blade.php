        ...
        <form method="POST" action="{{ route('login') }}"
            ...
            <div class="mt-10 w-full">
                ...
                <x-filament::input.wrapper>
                    <x-filament::input id="email" class="block mt-1 w-full" type="email" name="email"
                                       :value="old('email')"
                                       required
            ...
            <div class="mt-4 w-full">
                ...
                <x-filament::input.wrapper>
                    <x-filament::input id="password" class="block mt-1 w-full"
                                       type="password"
                                       name="password"
            ...
            <div class="flex mt-4 w-full justify-between">
                <label for="remember_me" class="pl-2 inline-flex items-center">
                    <x-filament::input.checkbox id="remember_me"
